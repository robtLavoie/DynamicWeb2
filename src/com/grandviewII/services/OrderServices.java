...
//**************************************************************************
	...
	public boolean findOrderObjectByID(String custID) {
		...
		EntityManager entityManager = entityManagerFactory.createEntityManager();
			...
			List<Orders> OrderFound = new ArrayList();
			OrderFound = query.getResultList();
...
//				IndexController.SingleOrder = OrderFound.get(0);
				result=true;
						}	
...
//						 if (orderFound.getListItems() != null) {
//							 for (Item  i:  orderFound.getListItems()) {
//			 					if (iId == i.getId()) {
//			 						result = false;
//			 						break;
//			 					}else {
...
//			 						listItems.add(item);
//			 						orderFound.setListItems(listItems);
////			 						orderFound.getListItems().add(entityManager.find(Item.class, iId));
//			 						entityManager.getTransaction().commit();	
//			 					}
//			 					
//			 				} 
